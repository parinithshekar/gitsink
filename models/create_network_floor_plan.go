...
func (m *CreateNetworkFloorPlan) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateImageContents(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CreateNetworkFloorPlan) validateBottomLeftCorner(formats strfmt.Registry) error {
...
func (m *CreateNetworkFloorPlan) validateBottomRightCorner(formats strfmt.Registry) error {
...
func (m *CreateNetworkFloorPlan) validateCenter(formats strfmt.Registry) error {
...
func (m *CreateNetworkFloorPlan) validateImageContents(formats strfmt.Registry) error {

	if err := validate.Required("imageContents", "body", m.ImageContents); err != nil {
		return err
	}
...
func (m *CreateNetworkFloorPlan) validateName(formats strfmt.Registry) error {
...
func (m *CreateNetworkFloorPlan) validateTopLeftCorner(formats strfmt.Registry) error {
...
func (m *CreateNetworkFloorPlan) validateTopRightCorner(formats strfmt.Registry) error {
...
func (m *CreateNetworkFloorPlan) UnmarshalBinary(b []byte) error {
	var res CreateNetworkFloorPlan
