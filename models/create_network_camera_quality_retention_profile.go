...
func (m *CreateNetworkCameraQualityRetentionProfile) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateNetworkCameraQualityRetentionProfile) validateName(formats strfmt.Registry) error {
...
func (m *CreateNetworkCameraQualityRetentionProfile) validateVideoSettings(formats strfmt.Registry) error {
...
func (m *CreateNetworkCameraQualityRetentionProfile) UnmarshalBinary(b []byte) error {
	var res CreateNetworkCameraQualityRetentionProfile
