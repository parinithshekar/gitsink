...
func (m *CreateOrganizationSamlRole) validateNetworks(formats strfmt.Registry) error {
...
func (m *CreateOrganizationSamlRole) validateTags(formats strfmt.Registry) error {
...
func (m *CreateOrganizationSamlRole) UnmarshalBinary(b []byte) error {
	var res CreateOrganizationSamlRole
