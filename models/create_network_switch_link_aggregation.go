...
func (m *CreateNetworkSwitchLinkAggregation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateNetworkSwitchLinkAggregation) validateSwitchPorts(formats strfmt.Registry) error {
...
func (m *CreateNetworkSwitchLinkAggregation) validateSwitchProfilePorts(formats strfmt.Registry) error {
...
func (m *CreateNetworkSwitchLinkAggregation) UnmarshalBinary(b []byte) error {
	var res CreateNetworkSwitchLinkAggregation
