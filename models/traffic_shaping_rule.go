...
func (m *TrafficShapingRule) validateDefinitions(formats strfmt.Registry) error {
...
func (m *TrafficShapingRule) validatePerClientBandwidthLimits(formats strfmt.Registry) error {
