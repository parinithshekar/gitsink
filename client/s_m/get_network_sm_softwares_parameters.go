...
// NewGetNetworkSmSoftwaresParams creates a new GetNetworkSmSoftwaresParams object
// with the default values initialized.
func NewGetNetworkSmSoftwaresParams() *GetNetworkSmSoftwaresParams {
	var ()
	return &GetNetworkSmSoftwaresParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkSmSoftwaresParamsWithTimeout creates a new GetNetworkSmSoftwaresParams object
...
// NewGetNetworkSmSoftwaresParamsWithContext creates a new GetNetworkSmSoftwaresParams object
...
// NewGetNetworkSmSoftwaresParamsWithHTTPClient creates a new GetNetworkSmSoftwaresParams object
...
/*GetNetworkSmSoftwaresParams contains all the parameters to send to the API endpoint
for the get network sm softwares operation typically these are written to a http.Request
*/
...
func (o *GetNetworkSmSoftwaresParams) WithTimeout(timeout time.Duration) *GetNetworkSmSoftwaresParams {
...
func (o *GetNetworkSmSoftwaresParams) WithContext(ctx context.Context) *GetNetworkSmSoftwaresParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetNetworkSmSoftwaresParams) WithHTTPClient(client *http.Client) *GetNetworkSmSoftwaresParams {
...
func (o *GetNetworkSmSoftwaresParams) WithDeviceID(deviceID string) *GetNetworkSmSoftwaresParams {
...
func (o *GetNetworkSmSoftwaresParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
