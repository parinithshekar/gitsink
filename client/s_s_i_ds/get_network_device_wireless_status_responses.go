...
func (o *GetNetworkDeviceWirelessStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkDeviceWirelessStatusOK()
...
func NewGetNetworkDeviceWirelessStatusOK() *GetNetworkDeviceWirelessStatusOK {
	return &GetNetworkDeviceWirelessStatusOK{}
}
...
func (o *GetNetworkDeviceWirelessStatusOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/devices/{serial}/wireless/status][%d] getNetworkDeviceWirelessStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkDeviceWirelessStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
