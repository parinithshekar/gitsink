...
func (o *GetNetworkSsidL3FirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSsidL3FirewallRulesOK()
...
func NewGetNetworkSsidL3FirewallRulesOK() *GetNetworkSsidL3FirewallRulesOK {
	return &GetNetworkSsidL3FirewallRulesOK{}
}
...
func (o *GetNetworkSsidL3FirewallRulesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/ssids/{number}/l3FirewallRules][%d] getNetworkSsidL3FirewallRulesOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkSsidL3FirewallRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
