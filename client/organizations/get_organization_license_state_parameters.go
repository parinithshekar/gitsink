...
// NewGetOrganizationLicenseStateParams creates a new GetOrganizationLicenseStateParams object
// with the default values initialized.
func NewGetOrganizationLicenseStateParams() *GetOrganizationLicenseStateParams {
	var ()
	return &GetOrganizationLicenseStateParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetOrganizationLicenseStateParamsWithTimeout creates a new GetOrganizationLicenseStateParams object
...
// NewGetOrganizationLicenseStateParamsWithContext creates a new GetOrganizationLicenseStateParams object
...
// NewGetOrganizationLicenseStateParamsWithHTTPClient creates a new GetOrganizationLicenseStateParams object
...
/*GetOrganizationLicenseStateParams contains all the parameters to send to the API endpoint
for the get organization license state operation typically these are written to a http.Request
*/
...
func (o *GetOrganizationLicenseStateParams) WithTimeout(timeout time.Duration) *GetOrganizationLicenseStateParams {
...
func (o *GetOrganizationLicenseStateParams) WithContext(ctx context.Context) *GetOrganizationLicenseStateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get organization license state params
func (o *GetOrganizationLicenseStateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get organization license state params
func (o *GetOrganizationLicenseStateParams) WithHTTPClient(client *http.Client) *GetOrganizationLicenseStateParams {
...
func (o *GetOrganizationLicenseStateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
