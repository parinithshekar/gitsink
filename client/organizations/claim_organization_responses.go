...
func (o *ClaimOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /organizations/{organizationId}/claim][%d] claimOrganizationOK  %+v", 200, o.Payload)
}
...
func (o *ClaimOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
