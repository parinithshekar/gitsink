...
func (o *GetNetworkClientLatencyHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkClientLatencyHistoryOK()
...
func NewGetNetworkClientLatencyHistoryOK() *GetNetworkClientLatencyHistoryOK {
	return &GetNetworkClientLatencyHistoryOK{}
}
...
func (o *GetNetworkClientLatencyHistoryOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/clients/{clientId}/latencyHistory][%d] getNetworkClientLatencyHistoryOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkClientLatencyHistoryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
