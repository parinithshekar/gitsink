...
func (o *GetNetworkHTTPServersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkHTTPServersOK()
...
func NewGetNetworkHTTPServersOK() *GetNetworkHTTPServersOK {
	return &GetNetworkHTTPServersOK{}
}
...
func (o *GetNetworkHTTPServersOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/httpServers][%d] getNetworkHttpServersOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkHTTPServersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
