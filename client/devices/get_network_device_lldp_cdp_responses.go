...
func (o *GetNetworkDeviceLldpCdpReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkDeviceLldpCdpOK()
...
func NewGetNetworkDeviceLldpCdpOK() *GetNetworkDeviceLldpCdpOK {
	return &GetNetworkDeviceLldpCdpOK{}
}
...
func (o *GetNetworkDeviceLldpCdpOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/devices/{serial}/lldp_cdp][%d] getNetworkDeviceLldpCdpOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkDeviceLldpCdpOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
