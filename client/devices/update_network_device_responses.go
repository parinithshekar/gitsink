...
func (o *UpdateNetworkDeviceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkDeviceOK()
...
func (o *UpdateNetworkDeviceOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/devices/{serial}][%d] updateNetworkDeviceOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkDeviceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
