...
func (o *UpdateNetworkCellularGatewaySettingsSubnetPoolReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkCellularGatewaySettingsSubnetPoolOK()
...
func NewUpdateNetworkCellularGatewaySettingsSubnetPoolOK() *UpdateNetworkCellularGatewaySettingsSubnetPoolOK {
	return &UpdateNetworkCellularGatewaySettingsSubnetPoolOK{}
}
...
func (o *UpdateNetworkCellularGatewaySettingsSubnetPoolOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/cellularGateway/settings/subnetPool][%d] updateNetworkCellularGatewaySettingsSubnetPoolOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkCellularGatewaySettingsSubnetPoolOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
