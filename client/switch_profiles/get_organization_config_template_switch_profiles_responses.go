...
/*GetOrganizationConfigTemplateSwitchProfilesOK handles this case with default header values.
...
func (o *GetOrganizationConfigTemplateSwitchProfilesOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/configTemplates/{configTemplateId}/switchProfiles][%d] getOrganizationConfigTemplateSwitchProfilesOK  %+v", 200, o.Payload)
}
