...
func (o *GetNetworkSwitchSettingsDscpToCosMappingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSwitchSettingsDscpToCosMappingsOK()
...
func NewGetNetworkSwitchSettingsDscpToCosMappingsOK() *GetNetworkSwitchSettingsDscpToCosMappingsOK {
	return &GetNetworkSwitchSettingsDscpToCosMappingsOK{}
}
...
func (o *GetNetworkSwitchSettingsDscpToCosMappingsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/settings/dscpToCosMappings][%d] getNetworkSwitchSettingsDscpToCosMappingsOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkSwitchSettingsDscpToCosMappingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
