...
func (o *UpdateNetworkSwitchSettingsQosRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkSwitchSettingsQosRuleOK()
...
func NewUpdateNetworkSwitchSettingsQosRuleOK() *UpdateNetworkSwitchSettingsQosRuleOK {
	return &UpdateNetworkSwitchSettingsQosRuleOK{}
}
...
func (o *UpdateNetworkSwitchSettingsQosRuleOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/switch/settings/qosRules/{qosRuleId}][%d] updateNetworkSwitchSettingsQosRuleOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkSwitchSettingsQosRuleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
