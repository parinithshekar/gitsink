...
func (o *GetNetworkSwitchSettingsQosRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSwitchSettingsQosRulesOK()
...
func NewGetNetworkSwitchSettingsQosRulesOK() *GetNetworkSwitchSettingsQosRulesOK {
	return &GetNetworkSwitchSettingsQosRulesOK{}
}
...
func (o *GetNetworkSwitchSettingsQosRulesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/settings/qosRules][%d] getNetworkSwitchSettingsQosRulesOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkSwitchSettingsQosRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
