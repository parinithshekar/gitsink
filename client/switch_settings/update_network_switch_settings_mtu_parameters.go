...
// NewUpdateNetworkSwitchSettingsMtuParams creates a new UpdateNetworkSwitchSettingsMtuParams object
// with the default values initialized.
func NewUpdateNetworkSwitchSettingsMtuParams() *UpdateNetworkSwitchSettingsMtuParams {
	var ()
	return &UpdateNetworkSwitchSettingsMtuParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateNetworkSwitchSettingsMtuParamsWithTimeout creates a new UpdateNetworkSwitchSettingsMtuParams object
...
// NewUpdateNetworkSwitchSettingsMtuParamsWithContext creates a new UpdateNetworkSwitchSettingsMtuParams object
...
// NewUpdateNetworkSwitchSettingsMtuParamsWithHTTPClient creates a new UpdateNetworkSwitchSettingsMtuParams object
...
/*UpdateNetworkSwitchSettingsMtuParams contains all the parameters to send to the API endpoint
for the update network switch settings mtu operation typically these are written to a http.Request
*/
...
func (o *UpdateNetworkSwitchSettingsMtuParams) WithUpdateNetworkSwitchSettingsMtu(updateNetworkSwitchSettingsMtu *models.UpdateNetworkSwitchSettingsMtu) *UpdateNetworkSwitchSettingsMtuParams {
	o.SetUpdateNetworkSwitchSettingsMtu(updateNetworkSwitchSettingsMtu)
	return o
}
...
func (o *UpdateNetworkSwitchSettingsMtuParams) SetUpdateNetworkSwitchSettingsMtu(updateNetworkSwitchSettingsMtu *models.UpdateNetworkSwitchSettingsMtu) {
	o.UpdateNetworkSwitchSettingsMtu = updateNetworkSwitchSettingsMtu
}
...
func (o *UpdateNetworkSwitchSettingsMtuParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UpdateNetworkSwitchSettingsMtu != nil {
		if err := r.SetBodyParam(o.UpdateNetworkSwitchSettingsMtu); err != nil {
			return err
		}
	}
