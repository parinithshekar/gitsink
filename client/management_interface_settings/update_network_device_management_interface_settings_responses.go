...
func (o *UpdateNetworkDeviceManagementInterfaceSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkDeviceManagementInterfaceSettingsOK()
...
func NewUpdateNetworkDeviceManagementInterfaceSettingsOK() *UpdateNetworkDeviceManagementInterfaceSettingsOK {
	return &UpdateNetworkDeviceManagementInterfaceSettingsOK{}
}
...
func (o *UpdateNetworkDeviceManagementInterfaceSettingsOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/devices/{serial}/managementInterfaceSettings][%d] updateNetworkDeviceManagementInterfaceSettingsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkDeviceManagementInterfaceSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
