...
func (o *UpdateNetworkTrafficAnalysisSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkTrafficAnalysisSettingsOK()
...
func NewUpdateNetworkTrafficAnalysisSettingsOK() *UpdateNetworkTrafficAnalysisSettingsOK {
	return &UpdateNetworkTrafficAnalysisSettingsOK{}
}
...
func (o *UpdateNetworkTrafficAnalysisSettingsOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/trafficAnalysisSettings][%d] updateNetworkTrafficAnalysisSettingsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkTrafficAnalysisSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
