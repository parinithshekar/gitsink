...
func (o *UpdateNetworkAlertSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkAlertSettingsOK()
...
func NewUpdateNetworkAlertSettingsOK() *UpdateNetworkAlertSettingsOK {
	return &UpdateNetworkAlertSettingsOK{}
}
...
func (o *UpdateNetworkAlertSettingsOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/alertSettings][%d] updateNetworkAlertSettingsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkAlertSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
