...
func (o *UpdateNetworkVlansEnabledStateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkVlansEnabledStateOK()
...
func NewUpdateNetworkVlansEnabledStateOK() *UpdateNetworkVlansEnabledStateOK {
	return &UpdateNetworkVlansEnabledStateOK{}
}
...
func (o *UpdateNetworkVlansEnabledStateOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/vlansEnabledState][%d] updateNetworkVlansEnabledStateOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkVlansEnabledStateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
