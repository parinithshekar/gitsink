...
func (a *Client) GetOrganizationWebhookLogs(params *GetOrganizationWebhookLogsParams, authInfo runtime.ClientAuthInfoWriter) (*GetOrganizationWebhookLogsOK, error) {
	...
	if params == nil {
		params = NewGetOrganizationWebhookLogsParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getOrganizationWebhookLogs",
		Method:             "GET",
		PathPattern:        "/organizations/{organizationId}/webhookLogs",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetOrganizationWebhookLogsReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetOrganizationWebhookLogsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getOrganizationWebhookLogs: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
