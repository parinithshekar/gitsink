...
func (o *GetNetworkSiteToSiteVpnReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSiteToSiteVpnOK()
...
func NewGetNetworkSiteToSiteVpnOK() *GetNetworkSiteToSiteVpnOK {
	return &GetNetworkSiteToSiteVpnOK{}
}
...
func (o *GetNetworkSiteToSiteVpnOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/siteToSiteVpn][%d] getNetworkSiteToSiteVpnOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkSiteToSiteVpnOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
