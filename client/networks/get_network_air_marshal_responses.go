...
func (o *GetNetworkAirMarshalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkAirMarshalOK()
...
func (o *GetNetworkAirMarshalOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/airMarshal][%d] getNetworkAirMarshalOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkAirMarshalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
