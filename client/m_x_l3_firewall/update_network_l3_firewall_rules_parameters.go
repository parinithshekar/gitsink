...
// NewUpdateNetworkL3FirewallRulesParams creates a new UpdateNetworkL3FirewallRulesParams object
// with the default values initialized.
func NewUpdateNetworkL3FirewallRulesParams() *UpdateNetworkL3FirewallRulesParams {
	var ()
	return &UpdateNetworkL3FirewallRulesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateNetworkL3FirewallRulesParamsWithTimeout creates a new UpdateNetworkL3FirewallRulesParams object
...
// NewUpdateNetworkL3FirewallRulesParamsWithContext creates a new UpdateNetworkL3FirewallRulesParams object
...
// NewUpdateNetworkL3FirewallRulesParamsWithHTTPClient creates a new UpdateNetworkL3FirewallRulesParams object
...
/*UpdateNetworkL3FirewallRulesParams contains all the parameters to send to the API endpoint
for the update network l3 firewall rules operation typically these are written to a http.Request
*/
type UpdateNetworkL3FirewallRulesParams struct {

	/*NetworkID*/
	NetworkID string
	/*UpdateNetworkL3FirewallRules*/
	UpdateNetworkL3FirewallRules *models.UpdateNetworkL3FirewallRules
...
func (o *UpdateNetworkL3FirewallRulesParams) WithUpdateNetworkL3FirewallRules(updateNetworkL3FirewallRules *models.UpdateNetworkL3FirewallRules) *UpdateNetworkL3FirewallRulesParams {
	o.SetUpdateNetworkL3FirewallRules(updateNetworkL3FirewallRules)
	return o
}
...
func (o *UpdateNetworkL3FirewallRulesParams) SetUpdateNetworkL3FirewallRules(updateNetworkL3FirewallRules *models.UpdateNetworkL3FirewallRules) {
	o.UpdateNetworkL3FirewallRules = updateNetworkL3FirewallRules
}
...
func (o *UpdateNetworkL3FirewallRulesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UpdateNetworkL3FirewallRules != nil {
		if err := r.SetBodyParam(o.UpdateNetworkL3FirewallRules); err != nil {
			return err
		}
	}
