...
*/
func (a *Client) DeleteOrganizationConfigTemplate(params *DeleteOrganizationConfigTemplateParams, authInfo runtime.ClientAuthInfoWriter) (*DeleteOrganizationConfigTemplateNoContent, error) {
