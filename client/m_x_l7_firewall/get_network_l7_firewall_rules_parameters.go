...
// NewGetNetworkL7FirewallRulesParams creates a new GetNetworkL7FirewallRulesParams object
// with the default values initialized.
func NewGetNetworkL7FirewallRulesParams() *GetNetworkL7FirewallRulesParams {
	var ()
	return &GetNetworkL7FirewallRulesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkL7FirewallRulesParamsWithTimeout creates a new GetNetworkL7FirewallRulesParams object
...
// NewGetNetworkL7FirewallRulesParamsWithContext creates a new GetNetworkL7FirewallRulesParams object
...
// NewGetNetworkL7FirewallRulesParamsWithHTTPClient creates a new GetNetworkL7FirewallRulesParams object
...
/*GetNetworkL7FirewallRulesParams contains all the parameters to send to the API endpoint
for the get network l7 firewall rules operation typically these are written to a http.Request
*/
type GetNetworkL7FirewallRulesParams struct {
