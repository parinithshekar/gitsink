...
for the create organization insight monitored media server operation typically these are written to a http.Request
*/
type CreateOrganizationInsightMonitoredMediaServerParams struct {

	/*CreateOrganizationInsightMonitoredMediaServer*/
	CreateOrganizationInsightMonitoredMediaServer *models.CreateOrganizationInsightMonitoredMediaServer
	/*OrganizationID*/
...
func (o *CreateOrganizationInsightMonitoredMediaServerParams) WithCreateOrganizationInsightMonitoredMediaServer(createOrganizationInsightMonitoredMediaServer *models.CreateOrganizationInsightMonitoredMediaServer) *CreateOrganizationInsightMonitoredMediaServerParams {
...
func (o *CreateOrganizationInsightMonitoredMediaServerParams) SetCreateOrganizationInsightMonitoredMediaServer(createOrganizationInsightMonitoredMediaServer *models.CreateOrganizationInsightMonitoredMediaServer) {
...
func (o *CreateOrganizationInsightMonitoredMediaServerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CreateOrganizationInsightMonitoredMediaServer != nil {
