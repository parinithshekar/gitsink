...
func (o *GetNetworkDeviceLatencyStatsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkDeviceLatencyStatsOK()
...
func NewGetNetworkDeviceLatencyStatsOK() *GetNetworkDeviceLatencyStatsOK {
	return &GetNetworkDeviceLatencyStatsOK{}
}
...
func (o *GetNetworkDeviceLatencyStatsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/devices/{serial}/latencyStats][%d] getNetworkDeviceLatencyStatsOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkDeviceLatencyStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
