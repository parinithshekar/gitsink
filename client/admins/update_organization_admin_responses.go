...
/*UpdateOrganizationAdminOK handles this case with default header values.
...
func (o *UpdateOrganizationAdminOK) Error() string {
	return fmt.Sprintf("[PUT /organizations/{organizationId}/admins/{id}][%d] updateOrganizationAdminOK  %+v", 200, o.Payload)
}
