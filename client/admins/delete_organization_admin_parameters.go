...
for the delete organization admin operation typically these are written to a http.Request
*/
...
// WithID adds the id to the delete organization admin params
func (o *DeleteOrganizationAdminParams) WithID(id string) *DeleteOrganizationAdminParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete organization admin params
func (o *DeleteOrganizationAdminParams) SetID(id string) {
	o.ID = id
}
