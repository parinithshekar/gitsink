...
func (o *UpdateNetworkSsidSplashSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateNetworkSsidSplashSettingsOK()
...
func NewUpdateNetworkSsidSplashSettingsOK() *UpdateNetworkSsidSplashSettingsOK {
	return &UpdateNetworkSsidSplashSettingsOK{}
}
...
func (o *UpdateNetworkSsidSplashSettingsOK) Error() string {
	return fmt.Sprintf("[PUT /networks/{networkId}/ssids/{number}/splashSettings][%d] updateNetworkSsidSplashSettingsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateNetworkSsidSplashSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
