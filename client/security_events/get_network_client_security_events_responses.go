...
func (o *GetNetworkClientSecurityEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkClientSecurityEventsOK()
...
func NewGetNetworkClientSecurityEventsOK() *GetNetworkClientSecurityEventsOK {
	return &GetNetworkClientSecurityEventsOK{}
}
...
func (o *GetNetworkClientSecurityEventsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/clients/{clientId}/securityEvents][%d] getNetworkClientSecurityEventsOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkClientSecurityEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
