...
func (o *GetNetworkSecurityEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSecurityEventsOK()
...
func NewGetNetworkSecurityEventsOK() *GetNetworkSecurityEventsOK {
	return &GetNetworkSecurityEventsOK{}
}
...
func (o *GetNetworkSecurityEventsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/securityEvents][%d] getNetworkSecurityEventsOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkSecurityEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
