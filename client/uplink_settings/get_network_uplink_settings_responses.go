...
func (o *GetNetworkUplinkSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkUplinkSettingsOK()
...
func NewGetNetworkUplinkSettingsOK() *GetNetworkUplinkSettingsOK {
	return &GetNetworkUplinkSettingsOK{}
}
...
func (o *GetNetworkUplinkSettingsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/uplinkSettings][%d] getNetworkUplinkSettingsOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkUplinkSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
